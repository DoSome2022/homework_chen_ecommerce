...
//   const searchParams = useSearchParams();
//   const sessionId = searchParams.get("session_id");
//   const urlOrderId   = searchParams.get("orderId");       // 直接從 query 拿
...
//   // 轉換函數
// const convertOrderDetails = (details: RawOrderDetails | null | undefined): OrderDetails => {
//   if (!details) return {};
...
//           setStatus("success");
//           setMessage("付款成功！正式訂單已建立，購物車已清空");
//           // 如果有 orderDetails，可繼續 setOrderDetails(convertOrderDetails(result.orderDetails));
//         } else {
//           setStatus("failed");
//           setMessage(orderResult.error || "訂單轉換失敗");
//         }
