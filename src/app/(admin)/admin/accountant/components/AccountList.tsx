...
import { format, startOfDay, endOfDay, startOfMonth, endOfMonth,  isAfter } from "date-fns";
import {
  Select,
  SelectContent,
  SelectItem,
...
export default function AccountList() {
  ...
  useEffect(() => {
    ...
    console.log('當前選擇:', selectedMonth);
    console.log('過濾後數據:', filteredEntries.length);
  }, [availableMonths, selectedMonth, filteredEntries]);
    ...
    <>
      ...
      <details className="mb-8">
        ...
        <p className="text-xs text-muted-foreground mt-2">
          * 累計至 {format(now, "yyyy年 MM月 dd日 HH:mm")} 的數據
        </p>
      </details>
